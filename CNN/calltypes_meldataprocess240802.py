...
#data_root = "/home/zj/Data/Calltypes/FSLTestNoAugImpr" #Testing Data
...
# Data directory
data_dir = '/home/zj/Data/Calltypes/FSLTrainNew'
...
for target, subdir in enumerate(subdirectories):
    ...
    for file in os.listdir(subdir_path):
        ...
        if audio_duration <= 3: # 5.5seconds -->3 seconds
...
data_df.to_csv('mel3secFSLTrainNew.csv', index=False)
print('len(data_df)')
print(len(data_df))
...
with h5py.File('../Dataset/mel3secFSLTrainNew.h5', 'w') as hf:
...
print('Save to h5 database mel3secFSLTrainNew.h5 successfully!')
